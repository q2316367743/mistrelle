...
| [03-article-aside.md](./writing/03-article-aside.md)           | 文章侧边栏（长文创作全能面板）：双布局自适应（窄栏分段/全屏分栏）、版本条（一篇文章多版本+去AI味流式改写/朱雀检测预留）、封面+插图管理、直出生图弹窗、写作风格预设与快捷指令注入输入框 |
