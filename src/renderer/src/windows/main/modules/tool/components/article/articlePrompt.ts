...
export const ARTICLE_SCENE_PROMPT = [
  ...
  '',
  '### 平台与写作风格',
  '- 文章条目的 platform 记录目标平台，style 记录写作风格（预设词汇如「种草分享」「深度长文」，或用户自定义描述；用户可在侧边栏调整）',
  '- 撰写 / 续写 / 改写正文前，先 article_list 确认目标文章的 platform 与 style，写作必须严格遵循其语气、结构与排版习惯；style 要求与平台模板叠加生效',
  '- 用户调整平台 / 风格后的写作请求，一律以最新元数据为准',
  '',
  '### 文件约定',
