...
import { aihotApiV1HotTopics, type AihotHotTopic } from '@/windows/main/modules/api/aihot'
import { openAihotStory } from './AihotStoryDrawer'
import { openLinkPreview } from '@/components/preview/LinkPreviewDrawer'
import { aihotNotifyError } from '@/windows/main/modules/aihot'
...
const handleClick = (topic: AihotHotTopic) => {
  ...
  if (storyId) {
    ...
    openLinkPreview(topic.links.aihot)
  }
}
