...
import { openDesignStylePut } from '@/windows/main/pages/design/list/modals/DesignStylePutDialog'
import DesignStyleDetailBody from './components/DesignStyleDetailBody.vue'
import { mapRemoteToDesignStyle } from '@/windows/main/pages/design/list/useOnlineDesignStyles'
