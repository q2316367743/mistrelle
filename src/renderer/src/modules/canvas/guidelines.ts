...
export const buildDesignStylesCatalog = (): string => {
  const lines: string[] = [
    '# 设计风格目录（内置预设）',
    '',
    '> 数据源：`DESIGN_STYLE_PRESETS`（本地内置 8 套；更多风格见在线库）。',
  ...
  lines.push(
    '',
    '## 推荐话术（未指定风格时）',
    '- **技术 / 开发者**：瑞士国际主义 / xAI / Grok / Notion',
    '- **生活方式 / 阅读**：日式侘寂 / Notion / Apple 苹果',
    '- **活动 / 青年**：美漫波普 / 包豪斯 / 手绘',
    '- **产品 / SaaS**：Apple 苹果 / Notion / 瑞士国际主义',
    '- **高端 / 仪式**：xAI / Grok / 日式侘寂 / 包豪斯',
    '',
