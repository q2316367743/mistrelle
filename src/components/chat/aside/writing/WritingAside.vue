<template>
  <div class="writing-aside">
    <div class="writing-aside__toolbar">
      <t-select v-model="root" class="writing-aside__root">
    ...
    <div class="writing-aside__body">
      <div class="writing-aside__tree">
        <t-tree
          :key="treeKey"
          :data="treeData"
          :load="treeLoad"
      ...
      <div class="writing-aside__doc">
        <div v-if="currentFile" class="writing-aside__doc-toolbar">
          ...
          <t-tag theme="primary" variant="light" size="small" class="writing-aside__doc-name">
            {{ currentFile.name }}
          </t-tag>
        </div>
        <div v-if="currentFile" class="writing-aside__doc-content">
          <monaco-editor-view
            v-show="mode === 'edit'"
            :value="content"
            language="markdown"
          ...
          />
          <div v-show="mode === 'preview'" class="writing-aside__preview">
            <chat-content :content="content" />
          </div>
        </div>
        <div v-else class="writing-aside__empty">从左侧选择文档，或点击 + 新建</div>
      </div>
    </div>
  </div>
</template>
